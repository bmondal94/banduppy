"""
Created on Wed Jul 15 13:22:58 2026
...
class UnfoldingBase:
    ...
    def banduppy_unfolding_testing(self): 
        ...
        return band_unfold.Unfold(ab_initio_code='qe', 
                                  qe_keywards=self.qe_keywards,
...
class TestBandsUnfolding(UnfoldingBase): 
    ...
    def test_unfolding_SiGe8atomUnitcell(self):
        qe_files_path = 'qe/Si_8atom/'
        sim_folder = SimulationParentFolder / f'{qe_files_path}/QESimulations' 
        ref_results_dir = SimulationParentFolder / f'{qe_files_path}/BandUPpyUnfoldedResults'
        ...
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        kpoints_file = SimulationParentFolder / f'{qe_files_path}/BandUPpyKpointsGen'
        self.sckpts = np.genfromtxt(kpoints_file / 'K_POINTS_SC.dat', skip_header=3, comments='!')
        self.pckpts = np.genfromtxt(kpoints_file / 'K_POINTS_PC.dat', skip_header=3, comments='!')
        with open(kpoints_file / "K_POINTS_SCPC_map.pkl", "rb") as f:
            self.sc_pc_kp_map = pickle.load(f)
        with open(kpoints_file / "K_POINTS_SpecialKpoints.pkl", "rb") as f:
            special_kpoints_pos_labels = pickle.load(f)
        print("- Reading band structure file - done")
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        print("- Unfolding band structure...")
        self.qe_keywards = {'output_file_dir': sim_folder, 
                            'save_file_prefix':'bulk_Si', 
